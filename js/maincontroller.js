...
smartkycApp.controller('crypbrokersCntl', function ($scope, $http) {
    ...
    function getUserDetails() {
        ...
        var requestObj = {
            method: 'POST',
            url: ServerApi + '/users/getUserDetails.php',
            data: postData
        };
    ...
    $scope.addUserInformation = function ($event) {
        ...
        var requestObj = {
            method: 'POST',
            url: ServerApi + '/users/addInfo.php',
            data: postData
        };
    ...
    $scope.addCompanyInformation = function ($event) {
        ...
        var requestObj = {
            method: 'POST',
            url: ServerApi + '/users/addCompanyInfo.php',
            data: postData
        };
...
//init functions
    ...
    function uploadFile() {
        ...
        var fd = new FormData();
        var url = ServerApi + '/users/uploadDocuments.php';
    ...
    $scope.updateGeneral = function () {
        ...
        var requestObj = {
            method: 'POST',
            url: ServerApi + '/users/updateUserDetails.php',
            data: postData
        };
