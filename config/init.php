...
$uncheck_foreign_key = "SET GLOBAL FOREIGN_KEY_CHECKS=0";
$check_foreign_key = "SET GLOBAL FOREIGN_KEY_CHECKS=1";

print_r($db->executeQuery($uncheck_foreign_key));
print_r($db->executeQuery($Table_users));
print_r($db->executeQuery($Table_company));
print_r($db->executeQuery($Table_userRegistration));
print_r($db->executeQuery($Table_usersImage));
print_r($db->executeQuery($Table_forgotPassword));
print_r($db->executeQuery($Table_emailVerification));
print_r($db->executeQuery($Table_order));
print_r($db->executeQuery($check_foreign_key));
