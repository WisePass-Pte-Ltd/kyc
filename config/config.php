...
class dbconfig
{
    public static $emailBaseUrl = "http://wisepass.co";

    /** @var string - Redis */
    public $HOST     = 'localhost';
    public $USER     = 'root';
    public $PASSWORD = 'password';
    public $DB_NAME  = 'wisepasskyc';

    public $admin_login_username = "admin";
    public $admin_login_email = "admin@admin.com";
    public $admin_login_pass = "admin";

    public static $adminMail = "admin@smarktyc.com";

    /** @var string - Email config */
    public static $EMAIL_HOST = 'email-smtp.us-east-1.amazonaws.com';
    public static $EMAIL_USERNAME = "AKIAJMZ7RAUYS47HCAWQ";
    public static $EMAIL_PASSWORD = "AoBQm46V5mNB+pAQcTEHcFHfFaRlj8jXN/plE5jjDeQu";
                                ...
                                <tr>
                                    <td>
                                        <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"text-align: center;background-color: transparent\">
                                            <tbody>
                                            <tr>
                                                <td style=\"text-align: center;\"><span style=\"font-size: 10px;color: #999999;font-family: 'Montserrat Light', sans-serif;\">Copyright © 2018 wisepass.co. All Rights Reserved.</span></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"text-align: center;background-color: white\">
                                            <tr>
                                                <td style=\"text-align: center;width: 100%;\">
                                                    <p style=\"text-align: center;font-size: 18px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;;width: 90%;margin: auto\">
                                                        Thank you for creating an account with wisepass.co.
                                                    </p>
                                                    </br>
                                                    <p style=\"text-align: justify;font-size: 18px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;;width: 90%;margin: auto\">
                                    ...
                                    <td>
                                        <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"text-align: center;background-color: white\">
                                            <tr>
                                                <td style=\"text-align: center;width: 100%;\">
                                                    <p style=\"text-align: justify;font-size: 18px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;;width: 90%;margin: auto\">
                                                        Thank you for submitting your order request with wisepass.co. Our team is currently reviewing your order details and will be in contact with you soon.
                                                    </p>
                                                    </br>
                                                    <p style=\"text-align: left;font-size: 18px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;;width: 90%;margin: auto\">
